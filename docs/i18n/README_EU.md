...
**Zure zikloa. Zure telefonoa. Zerbitzaririk ez. Lainorik ez. Zero konpromisorik.**
...
```
Partekatutako Rust nukleoa (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher enkriptatua · zero sare
```
