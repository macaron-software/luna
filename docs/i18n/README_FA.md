...
**چرخه شما. تلفن شما. بدون سرور. بدون ابر. بدون مصالحه.**
...
```
هسته Rust مشترک (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher رمزنگاری شده · صفر شبکه
```
