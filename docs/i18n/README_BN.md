...
**আপনার চক্র। আপনার ফোন। কোনো সার্ভার নেই। কোনো ক্লাউড নেই। শূন্য আপোস।**
...
```
ভাগ করা Rust কোর (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher এনক্রিপ্টেড · শূন্য নেটওয়ার্ক
```
