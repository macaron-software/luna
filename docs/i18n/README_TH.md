...
**รอบเดือนของคุณ โทรศัพท์ของคุณ ไม่มีเซิร์ฟเวอร์ ไม่มีคลาวด์ ไม่มีการประนีประนอม**
...
```
Rust core ที่ใช้ร่วมกัน (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher เข้ารหัส · ไม่มีเครือข่าย
```
