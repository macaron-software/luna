...
# LUNA — Bahasa Indonesia

**Siklus Anda. Ponsel Anda. Tanpa server. Tanpa cloud. Nol kompromi.**
...
## Yang tidak akan PERNAH dilakukan LUNA
...
```
Inti Rust bersama (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher terenkripsi · nol jaringan
```
