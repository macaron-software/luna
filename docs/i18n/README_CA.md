...
**El teu cicle. El teu telèfon. Cap servidor. Cap núvol. Zero compromisos.**
...
```
Nucli Rust compartit (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher xifrat · zero xarxa
```
