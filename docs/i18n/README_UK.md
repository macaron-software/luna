...
**Ваш цикл. Ваш телефон. Жодних серверів. Жодної хмари. Нуль компромісів.**
...
```
Спільне ядро Rust (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher зашифровано · нуль мережі
```
