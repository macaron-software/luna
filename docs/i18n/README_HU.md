...
**A te ciklusod. A te telefonod. Nincs szerver. Nincs felhő. Nulla kompromisszum.**
...
## Amit a LUNA SOHA nem fog csinálni
...
```
Zdieľané Rust jadro (UniFFI) · SwiftUI iOS · Kotlin Android · SQLCipher šifrovaný · nula sieť
```
